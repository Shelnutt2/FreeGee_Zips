...
${TOOLS}/busybox md5sum /data/local/tmp/aboot-after.img | ${TOOLS}/busybox grep "8bf3aae9a45f905061c481c1c6bd0283"
if (("$?" != "0")); then
restore
fi

${TOOLS}/busybox md5sum /data/local/tmp/laf-after.img | ${TOOLS}/busybox grep "f613f1251680aaa06a537ecfeac960f9"
if (("$?" != "0")); then
