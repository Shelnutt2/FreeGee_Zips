...
${TOOLS}/busybox md5sum /data/local/tmp/aboot-after.img | ${TOOLS}/busybox grep "1923c7a5b84548404d0cea498e43ceba"
if (("$?" != "0")); then
restore
fi

${TOOLS}/busybox md5sum /data/local/tmp/laf-after.img | ${TOOLS}/busybox grep "0c98bbb6ea506ac7e96ed81427e295da"
if (("$?" != "0")); then
